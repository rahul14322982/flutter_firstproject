...
class food_8 extends StatelessWidget {
  const food_8({super.key});

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: Text("Egg_Burji"),
        centerTitle: true,
      ),
      ...
      body: Column(
        children: [
          Container(
            ...
            AssetImage("assets/flutter_image10.jpg"),
            fit:BoxFit.cover
            ),
            ),
           ),
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 8,),
                Text("perfectly Egg_Burji. A spicy and satisfying meal ",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
                Text("for just ₹50! Freshly made | Hygienic | Filling Portion",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 15,),
                Text("Tasty Egg Burji",
               style: TextStyle(fontSize: 25),),
                SizedBox(height: 8,),
                Text("Spicy Egg_Burji – full flavor ",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
                Text("in every bite!Only ₹50",
                style: TextStyle(fontSize: 15),),
