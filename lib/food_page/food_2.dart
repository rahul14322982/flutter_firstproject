...
class food_2 extends StatelessWidget {
  const food_2({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Egg_noodles"),
        centerTitle: true,
      ),
      body:  Column(
        children: [
          Container(
            ...
            AssetImage("assets/flutter_image4.jpg"),
            fit:BoxFit.cover
            ),
            ),
           ),
