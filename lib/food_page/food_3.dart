...
class food_3 extends StatelessWidget {
  const food_3({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Half_boild_omelet"),
        centerTitle: true,
      ),
      body:Column(
        children: [
          Container(
            ...
            AssetImage("assets/flutter_image5.jpg"),
            fit:BoxFit.cover
            ),
            ),
           ),
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
                Text("for just ₹15! Freshly made | Hygienic | Filling Portion",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 15,),
                Text("Tasty boild_omelet",
               style: TextStyle(fontSize: 25),),
                SizedBox(height: 8,),
                Text("Spicy with boiled omelet – full flavor ",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
                Text("in every bite!Only ₹15",
                style: TextStyle(fontSize: 15),),
