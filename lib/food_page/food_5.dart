...
class food_5 extends StatelessWidget {
  const food_5({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Egg_Burger"),
        centerTitle: true,
      ),
      body:Column(
        children: [
          Container(
            ...
            AssetImage("assets/flutter_image7.jpg"),
            fit:BoxFit.cover
            ),
            ),
           ),
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 8,),
                Text("perfectly egg_Burger. A spicy and satisfying meal ",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
                Text("for just ₹80! Freshly made | Hygienic | Filling Portion",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 15,),
                Text("Tasty Egg Burger",
               style: TextStyle(fontSize: 25),),
                SizedBox(height: 8,),
                Text("Spicy Egg_Burger – full flavor ",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
