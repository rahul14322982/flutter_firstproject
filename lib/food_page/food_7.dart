...
class food_7 extends StatelessWidget {
  const food_7({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bread_omelet_Sandwhich"),
        centerTitle: true,
      ),
      ...
      body: Column(
        children: [
          Container(
            ...
            AssetImage("assets/flutter_image9.jpg"),
            fit:BoxFit.cover
            ),
            ),
           ),
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 8,),
                Text("perfectly Sandwhich. A spicy and satisfying meal ",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
                Text("for just ₹80! Freshly made | Hygienic | Filling Portion",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 15,),
                Text("Tasty Bread_Sandwhich",
               style: TextStyle(fontSize: 25),),
                SizedBox(height: 8,),
                Text("Spicy Bead_Omelet_Sandwhich – full flavor ",
                style: TextStyle(fontSize: 15),),
                SizedBox(height: 8,),
                Text("in every bite!Only ₹80",
                style: TextStyle(fontSize: 15),),
